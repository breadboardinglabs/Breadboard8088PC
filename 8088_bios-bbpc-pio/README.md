...
floppy2.inc has extra POST debug, EE leads disk read parameters, specify byte updated to disable DMA, Read and Write commands turned off multi-track, uses 1440 values by default not 2880
